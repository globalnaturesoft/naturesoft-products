module Naturesoft
  module Products
    module Admin
      class ManufacturersController < Naturesoft::Admin::AdminController
        ...
        def create
          ...
          if @manufacturer.save
            redirect_to naturesoft_products.edit_admin_manufacturer_path(@manufacturer.id), notice: 'Manufacturer was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          if @manufacturer.update(manufacturer_params)
            redirect_to naturesoft_products.edit_admin_manufacturer_path(@manufacturer.id), notice: 'Manufacturer was successfully updated.'
          else
            render :edit
          end
        end
