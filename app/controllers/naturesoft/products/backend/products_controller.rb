module Naturesoft
  module Products
    module Backend
      class ProductsController < Naturesoft::Backend::BackendController
        before_action :set_product, only: [:show, :edit, :update, :enable, :disable, :destroy]
        before_action :default_breadcrumb
        
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Product", naturesoft_products.backend_products_path
          add_breadcrumb "Products", naturesoft_products.backend_products_path
        end
        ...
        def create
          ...
          if @product.save
            redirect_to naturesoft_products.edit_backend_product_path(@product.id), notice: 'Product was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          ...
          if @product.update(product_params)
            redirect_to naturesoft_products.edit_backend_product_path(@product.id), notice: 'Product was successfully updated.'
          else
            render :edit
          end
        end
