    ...
    module Backend
      class CategoriesController < Naturesoft::Backend::BackendController
        ...
        def default_breadcrumb
          add_breadcrumb "Product", naturesoft_products.backend_categories_path
          add_breadcrumb "Categories", naturesoft_products.backend_categories_path
        end
        ...
        def create
          ...
          if @category.save
            redirect_to naturesoft_products.edit_backend_category_path(@category.id), notice: 'Category was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          if @category.update(category_params)
            redirect_to naturesoft_products.edit_backend_category_path(@category.id), notice: 'Category was successfully updated.'
          else
            render :edit
          end
        end
