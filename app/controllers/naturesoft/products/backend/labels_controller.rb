module Naturesoft
  module Products
    module Backend
      class LabelsController < Naturesoft::Backend::BackendController
        before_action :set_label, only: [:show, :edit, :update, :enable, :disable, :destroy]
        before_action :default_breadcrumb
        
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Product", naturesoft_products.backend_labels_path
          add_breadcrumb "Labels", naturesoft_products.backend_labels_path
        end
        ...
        def create
          ...
          if @label.save
            redirect_to naturesoft_products.edit_backend_label_path(@label.id), notice: 'Label was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          if @label.update(label_params)
            redirect_to naturesoft_products.edit_backend_label_path(@label.id), notice: 'Label was successfully updated.'
          else
            render :edit
          end
        end
