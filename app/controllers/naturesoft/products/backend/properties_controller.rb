module Naturesoft
  module Products
    module Backend
      class PropertiesController < Naturesoft::Backend::BackendController
        before_action :set_property, only: [:show, :edit, :update, :enable, :disable, :destroy]
        before_action :default_breadcrumb
        
        # add top breadcrumb
        def default_breadcrumb
          add_breadcrumb "Product", naturesoft_products.backend_properties_path
          add_breadcrumb "Properties", naturesoft_products.backend_properties_path
        end
        ...
        def create
          ...
          if @property.save
            redirect_to naturesoft_products.edit_backend_property_path(@property.id), notice: 'Property was successfully created.'
          else
            render :new
          end
        end
        ...
        def update
          if @property.update(property_params)
            redirect_to naturesoft_products.edit_backend_property_path(@property.id), notice: 'Property was successfully updated.'
          else
            render :edit
          end
        end
